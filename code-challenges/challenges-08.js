...
//   let values = Object.values(obj);
  for (let x in obj ) {
      result.push(`Customer Name :${x} , Age :${obj[x]}`) ;
  }
  return (result);
};
// -------------------------------------------------------------------------------------------------------
...
const getInfo = (arr) => {
  ...
  let studentsName = [];
  // write your code here
  for (let indexObj of arr ) {
    coursesName.push(`${indexObj.course}`) ;
    for (let j of indexObj.Students ) {
        studentsName.push(j);
    }
  }
...
const getStudents = (arr) => {
  ...
  for (let indexObj of arr ) {
    for (let j of indexObj.Students ) {
        arry.push({Student: j, course: indexObj.course});
    }
  }
  return arry;
};
